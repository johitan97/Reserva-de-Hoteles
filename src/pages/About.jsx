...
function About() {
    ...
    <div className="container aboutus">
        <div className="row">
            ...
            <div className="col-md-6 col-12 my-auto">
                <h1 className="display-4 text-center my-5">Quienes Somos </h1>
                ...
                <div className="text-center col-md-6 col-12 mx-auto">
                    <Link to="/contact" className="btn btn-outline-dark btn-block btn-lg my-5">Contactanos</Link>
                </div>
            </div>
        </div>
        <div className="about_company">
            <h1 className="display-4">Nuestra Compañia</h1>
            <div className="pt-4">
        ...
        <div className="testimony">
            <h1 className="display-4 mb-4">Que Dice Nuestros Clientes</h1>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4 col-12 my-auto">
                                        <div className="text-dark">
                                            <h3 className="font-weight-bolder ">Nuestros Clientes</h3>
        ...
        <div className="row mb-5">
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-text text-black-50">Presidente <p className="float-right">5 años</p>
                        </div>
                        <h6 className="mt-5">Contactalos</h6>
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    ...
                    <div className="card-body">
                        <h5 className="card-title mb-0">Lider de Equipo</h5>
                        <div className="card-text text-black-50">Lider de Marca <p className="float-right">5 años</p>
                        </div>
                        <h6 className="mt-5">Contactalos</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    ...
                    <div className="card-body">
                        <h5 className="card-title mb-0">Jefa de Mercadeo</h5>
                        <div className="card-text text-black-50">Mercadeo <p className="float-right">8 años</p>
                        </div>
                        <h6 className="mt-5">Contactalos</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
